 ...
 */
public class CustomReferenceValuesSourceNodeTest extends RavenCoreTestCase
{
    @Test
    public void test()
    {
        ...
        assertNull(source.getReferenceValues());
        ...
        assertEquals(new Integer(1), values.get(0).getValue());
    }
}