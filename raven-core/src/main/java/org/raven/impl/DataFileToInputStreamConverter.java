 ...
 */
public class DataFileToInputStreamConverter extends AbstractConverter<DataFile, InputStream>{

    public InputStream convert(DataFile value, Class realTargetType, String format) {
        try {
