...
public class BasicAuthenticator implements Authenticator
{
    ...
    {
        boolean testMode = config.getBooleanProperty(Configurator.TEST_MODE, Boolean.FALSE);
        if (testMode){
            logger.warn("Authentication work in TEST MODE!");
        }
        return config.getBooleanProperty(Configurator.TEST_MODE, Boolean.FALSE);
    }
}
