 ...
 */
public class DataStreamValueHandlerFactory implements AttributeValueHandlerFactory
{
    public final static String TYPE = "DataStream";
    private final NodePathResolver pathResolver;

    public DataStreamValueHandlerFactory(NodePathResolver pathResolver)
    {
    ...
    {
        try {
            return new DataStreamValueHandler(attribute);
        }
        catch (DataStreamValueHandlerException ex)
        {
