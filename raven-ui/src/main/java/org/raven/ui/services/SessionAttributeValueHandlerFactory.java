 ...
 */
public class SessionAttributeValueHandlerFactory implements AttributeValueHandlerFactory
{
    public final static String TYPE = "Session attribute";

    public AttributeValueHandler createValueHandler(NodeAttribute attribute)
    {
        return new SessionAttributeValueHandler(attribute);
    }
