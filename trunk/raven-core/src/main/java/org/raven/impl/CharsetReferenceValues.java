 ...
 */
public class CharsetReferenceValues implements AttributeReferenceValues
{
    public boolean getReferenceValues(
            NodeAttribute attr, ReferenceValueCollection referenceValues)
        throws TooManyReferenceValuesException
    {
        if (!Charset.class.equals(attr.getType()))
            return false;
