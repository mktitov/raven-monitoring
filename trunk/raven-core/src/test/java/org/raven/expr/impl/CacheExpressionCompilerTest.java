 ...
 */
public class CacheExpressionCompilerTest extends Assert
{
	@Test
	public void notInCacheTest() throws Exception
	{
		ExpressionCache cache = createMock(ExpressionCache.class);
		expect(cache.getExpression("expression")).andReturn(null);
		replay(cache);
	...
	@Test
	public void inCacheTest() throws Exception
	{
		ExpressionCache cache = createMock(ExpressionCache.class);
		Expression cachedExpression = createMock(Expression.class);
		expect(cache.getExpression("expression")).andReturn(cachedExpression);
