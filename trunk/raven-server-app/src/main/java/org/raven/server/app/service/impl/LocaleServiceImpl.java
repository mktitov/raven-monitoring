 ...
 */
public class LocaleServiceImpl implements Locale
{
    private final RavenServletContext servletContext;

    public LocaleServiceImpl(RavenServletContext servletContext)
    {
    ...
    public java.util.Locale getCurrent()
    {
        ...
        return request!=null? request.getLocale() : java.util.Locale.getDefault();
    }
}
